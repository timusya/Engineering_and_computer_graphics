...
public:
    ...
    Main()
    {
        ...
        m_directionalLight.DiffuseIntensity = 0.15f;
        m_directionalLight.Direction = Vector3f(0.0f, -1.0f, 0.0f);
    }
    ...
    bool Init()
    {
        Vector3f Pos(0.0f, 15.0f, 0.0f);
        Vector3f Target(0.0f, 0.0f, 1.0f);
        Vector3f Up(1.0, 0.0f, 0.0f);
        ...
        m_pTexture = new Texture(GL_TEXTURE_2D, "../Content/electro.jpg");
    ...
    virtual void RenderSceneCB()
    {
        ...
        sl[2].Color = Vector3f(1.0f, 1.0f, 1.0f);
        sl[2].AmbientIntensity = 5.0f;
        sl[2].DiffuseIntensity = 15.0f;
        sl[2].Position = Vector3f(0.0f, 5.0f, 0.0f);
        sl[2].Direction = Vector3f(cosf(m_scale + 2.14), -1.0f, sinf(m_scale));
